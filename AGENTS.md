...
intermediate Java coding conventions](https://se-education.org/guides/conventions/java/intermediate.html).
Apply it to new code, modifications, and refactoring, and inspect the final
diff for violations before handing work back.
...
`seedu-git-standard` skill at `.codex/skills/seedu-git-standard/SKILL.md`, based
on the [SE-EDU Git conventions](https://se-education.org/guides/conventions/git.html).
Before creating or proposing a commit, validate its subject, body, and branch
name against that skill.
